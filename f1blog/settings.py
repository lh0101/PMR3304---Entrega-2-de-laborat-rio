...
import os
import dj_database_url  # Adicione esta importação para gerenciar o banco de dados no Render
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'F1BLOG.onrender.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Define a pasta 'templates' na raiz do projeto
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Database
# Usando o dj_database_url para suportar múltiplos ambientes
DATABASES = {
